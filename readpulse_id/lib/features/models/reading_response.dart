class ReadingResponse {
  ...
  final int
  formatPreference; // 0=digital, 1=cetak, 2=keduanya, 3=tidak suka keduanya
  final int genreVariety; // 0-4
  final int purpose; // 0=tugas, 1=hobi, 2=keduanya, 3=tidak keduanya
  final int
  readingHabitDuration; // 0=0-1bln, 1=1-3bln, 2=3-6bln, 3=6-12bln, 4=>1th
  final int discussionHabit; // 0=tidak pernah, 1=jarang, 2=sering
  final int
  readingCommunity; // 0=tidak ikut, 1=ikut tidak aktif, 2=jarang aktif, 3=sangat aktif
  ...
  Map<String, dynamic> toJson() {
    // convert enjoymentScale (UI 1..5) to backend expected 0..4
    final enjoymentForApi = (enjoymentScale > 0)
        ? (enjoymentScale - 1)
        : enjoymentScale;
    return {
      'frequency_per_week': frequencyPerWeek,
      'minutes_per_day': minutesPerDay,
      'enjoyment_scale': enjoymentForApi,
